...
final mascotLocalDataSourceProvider =
    AutoDisposeProvider<MascotLocalDataSource>.internal(
      mascotLocalDataSource,
      name: r'mascotLocalDataSourceProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$mascotLocalDataSourceHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
final mascotRepositoryProvider = AutoDisposeProvider<MascotRepository>.internal(
  mascotRepository,
  name: r'mascotRepositoryProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$mascotRepositoryHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final completeTodoUseCaseProvider =
    AutoDisposeProvider<CompleteTodoUseCase>.internal(
      completeTodoUseCase,
